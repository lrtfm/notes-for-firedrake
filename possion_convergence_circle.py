...
def test_possion_circle(refine, degree, exact_handle=None, iso=False, only_move_bdy=False):
    ...
    for i, sol in enumerate(sols[:-1]):
        ...
        errors.append(errornorm(u_exact, sol))
...
if __name__ == '__main__':
    ...
    max_degree = opts.getInt('max_degree', default=4)
    ...
    exact_handle = lambda x: 1 - (x[0]**2 + x[1]**2)**3.5
    ...
    for degree in range(1, max_degree+1):
        ...
        for iso in iso_list:
            ...
            for only_move_bdy in move_bdy_list:
                ...
                PETSc.Sys.Print(f'    orders: {data["orders"]}\n') 
